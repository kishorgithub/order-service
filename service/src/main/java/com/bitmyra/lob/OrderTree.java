...
public class OrderTree {
	TreeMap<Double, OrderList> priceTree = new TreeMap<>();
	HashMap<Double, OrderList> priceMap = new HashMap<>();;
	...
	public void insertOrder(Order quote) {
		...
		volume = volume + quote.getQuantity();
	}
	...
	public void updateOrder(Order orderUpdate) {
		int idNum = orderUpdate.getQueueId();
		...
		this.volume = this.volume + (order.getQuantity() - originalVol);
	}
